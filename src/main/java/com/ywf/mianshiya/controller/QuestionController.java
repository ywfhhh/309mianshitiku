...
import com.ywf.mianshiya.easyexcel.QuestionDataListener;
import com.ywf.mianshiya.exception.BusinessException;
import com.ywf.mianshiya.exception.ThrowUtils;
import com.ywf.mianshiya.model.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<QuestionVO> getQuestionVOById(long id, HttpServletRequest request) {
        ...
        if (user != null) {
            crawlerDetect.crawlerDetect(user.getId());
        }
        // 查询数据库
    ...
    public BaseResponse<Page<Question>> listQuestionByPage(@RequestBody QuestionQueryRequest questionQueryRequest) {
        ThrowUtils.throwIf(questionQueryRequest == null, ErrorCode.PARAMS_ERROR, "查询条件为空");
    ...
    public BaseResponse<Page<QuestionVO>> listQuestionVOByPageSentinel(@RequestBody QuestionQueryRequest
                                                                               questionQueryRequest,
                                                                       HttpServletRequest request) {
        // 基于 IP 限流
    ...
    @PostMapping("/upload")
    public BaseResponse<Boolean> upload(@RequestParam("file") MultipartFile file, HttpServletRequest request) throws IOException {
        QuestionDataListener listener = new QuestionDataListener();
        EasyExcel.read(file.getInputStream(), Question.class, listener).sheet().doRead();
        Long userId = userService.getLoginUser(request).getId();
        List<Question> questions = listener.getCachedDataList().stream().map(question -> {
            question.setUserId(userId);
            return question;
        }).collect(Collectors.toList());
        questionService.batchSaveQuestions(questions);
        return ResultUtils.success(true);
    }
